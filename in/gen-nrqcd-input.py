...
run_root="./"
prop_root = "/lustre5/dc-mcle2/BtoD/hl-2pt-exec/temp/"  # Propagator location.
out_dir = run_root + "correlators_trev_set1/"  # Output directory.
...
def prop_name(config, tsrc):
    return "l3296f211b630m0074m037m440-coul.{0}_wallprop_m0.0376_th0.0_t{1}.binary".format(config,tsrc)

def prop_dir(prop_root, mass):
    return prop_root

def src_name(prop_root,config, tsrc):
    return prop_root+"l3296f211b630m0074m037m440-coul.{0}_wallprop_m0.0376_th0.0_t{1}.source.binary".format(config,tsrc)
